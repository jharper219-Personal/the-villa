...
export const dayPreview = (d) => ({ 1: 'Ten singles, one villa, a bombshell before bedtime.', 2: 'The bombshell picks two dates. Someone\'s partner watches.', 3: 'A challenge, and the first real chats.', 4: 'Recoupling. The islander left standing goes home.', 5: 'Two bombshells. You choose who walks in.', 6: 'Dates for the new arrivals, and the Hideaway opens.', 7: 'The heart rate challenge. Monitors don\'t lie.', 8: 'A recoupling with everyone safe. For now.', 9: `${PUBLIC} votes. The islanders decide who goes.`, 10: 'A date for a couple of your choosing, and one more bombshell.', 11: 'Recoupling. One islander is dumped tonight.', 12: 'A challenge that gets a little too honest.', 13: 'Casa Amor. The boys leave. The bombshells arrive.', 14: 'A postcard. Do you send it?', 15: 'Stick or twist. The walk back to the fire pit.', 16: 'Movie night. The villa has been watching.', 17: 'Kiss, Marry, Pie, then a dumping.', 18: 'Two late bombshells looking to break something up.', 19: 'The last recoupling.', 20: 'A couple is dumped days from the final.', 21: 'Families visit. Then the final four are set.', 22: 'Declarations, the winners, and the envelope.' }[d] || '');
